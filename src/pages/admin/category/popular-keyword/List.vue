<template>
  <page-header title="인기검색어" breadcrumbsDepth1="인기검색어" />
  <div class="layout fluid page-container">
    ...
    <va-divider />
    <div class="row">
      <va-input v-model="name" placeholder="인기검색어를 입력해주세요." />
      <va-input v-model="priority" placeholder="인기검색어를 입력해주세요." style="margin-start: 40px; margin-end: 40px" />
