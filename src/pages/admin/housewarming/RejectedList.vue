<template>
  <page-header v-if="isLanHousewarming" title="랜선 집들이 반려" breadcrumbsDepth1="랜선 집들이 반려" />
  <page-header v-if="!isLanHousewarming" title="전문가 집들이 반려" breadcrumbsDepth1="전문가 집들이 반려" />
