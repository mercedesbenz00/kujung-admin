  ...
  <div>
    ...
    <div v-if="userInfo !== undefined" class="search-form" style="margin-top: 20px">
      <div class="row">
        ...
        <div class="flex flex-col search-form-value-small">
          <div>
            ...
            <va-button preset="secondary" border-color="primary" size="small" @click="onExit" style="margin-start: 10px"
              >강제 탈퇴</va-button
            >
          </div>
        </div>
      ...
      <div class="row" style="margin-top: -1px">
        <div class="search-form-label">아이디</div>
        <div class="flex flex-col search-form-value-small">
          {{ userInfo.id }}
        </div>
      ...
      <div class="row" style="margin-top: -1px">
        ...
        <div class="search-form-label" style="margin-left: -1px">SNS 종류</div>
        <div class="flex flex-col search-form-value-small">
          {{ userInfo.sns_type }}
        </div>
      </div>
      ...
      <div class="row" style="margin-top: -1px">
        ...
        <div class="flex flex-col search-form-value-small">{{ userInfo.point }} P</div>
        <div class="search-form-label" style="margin-left: -1px">가입일시</div>
        <div class="flex flex-col search-form-value-small">
